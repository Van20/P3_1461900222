        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">PENGATURAN DATA JENIS BUKU</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List Jenis Buku</h6>
                        </div>
                        <div class="card-body">
                            <a class="collapse-item" href="{{'/addJenisBookPage'}}">
                                <button type="button" class="btn btn-outline-primary">Tambah Jenis Buku +</button> 
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $no=1 ?>
                                        @foreach ($addJenisBuku as $jenis_buku)
                                        <tr>
                                            <td>{{ $no++ }}</td>
